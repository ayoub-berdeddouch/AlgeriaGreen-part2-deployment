...
- A **VGG16 image classification model** is developed which can detect whether a tomato leaf is healthy or infected along with the disease type if its affected.
